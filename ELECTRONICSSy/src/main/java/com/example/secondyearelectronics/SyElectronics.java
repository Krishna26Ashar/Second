...
public class SyElectronics extends AppCompatActivity {
    private Button button1;
    private Button button2;
    private Button button3;
    private Button logout;
    public static final String Pref_username = "SY_ELECTRONICS";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sy_electronics);
    ...
    public void openLogin()
    {
        ...
        editor.commit();
        finish();
        Intent intent = new Intent(SyElectronics.this, LoginElectronics.class);
        startActivity(intent);
    }
